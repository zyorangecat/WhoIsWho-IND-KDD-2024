...
MAX_SOURCE_LEN=8196 # longer context contains more paper titles, but cost longer train time and larger memory usage
MAX_TARGET_LEN=16
DEV_BATCH_SIZE=1
...
RUN_NAME=text
BASE_MODEL_PATH=model/LLM-Research/Meta-Llama-3-8B-Instruct
PUB_PATH=data/IND-WhoIsWho/pid_to_info_all.json
TRAIN_PATH=IND-WhoIsWho/train_author.json
